...
//        return new ImageIcon(Objects.requireNonNull(getClass().getResource("toolWindow/auto-generate.svg")));
        // load("toolwindows/webToolWindow.svg", -1661468267, 2);load("toolwindows/webToolWindow.svg", -1661468267, 2);
//        return AllIcons.Toolwindows.WebToolWindow;
//        return IconManager.getInstance().loadRasterizedIcon("toolWindow/auto-generate.svg", AllIcons.class.getClassLoader(), -1661468267, 2);
    }
