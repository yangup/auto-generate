...
//    @JsonProperty("method")
    ...
    // todo: 金额
    @DecimalMin(value = "0", message = "amount is empty or incorrect")
    @DecimalMax(value = "13.2", message = "amount is empty or incorrect")
    @Digits(integer = 13, fraction = 2, message = "amount is empty or incorrect")
//    @JsonProperty("amount")
    public BigDecimal amount;

    // todo: 收款金额
//    @DecimalMin(value = "0", message = "billAmount is empty or incorrect")
//    @DecimalMax(value = "13.2", message = "billAmount is empty or incorrect")
...
//    @JsonProperty("transaction_time")
    ...
    // todo: 渠道费
//    @DecimalMin(value = "0", message = "channelFee is empty or incorrect")
//    @DecimalMax(value = "13.2", message = "channelFee is empty or incorrect")
